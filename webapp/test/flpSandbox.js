		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#sapbtpsapui551-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtpsapui551-display": {
								"semanticObject": "sapbtpsapui551",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.sapui551",
									"url": sap.ui.require.toUrl("sap/btp/sapui551")
								}
							}
						}
					}
